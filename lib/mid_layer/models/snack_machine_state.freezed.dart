...
mixin _$SnackMachineState {
 ...
 CoinStack get coinStorage; CoinStack get changeSlot; List<SnackSlot> get snackStorage; SnackTMP? get ejectedSnack; VendingState get vendingState;
...
@useResult
$Res call({
 CoinStack coinStorage, CoinStack changeSlot, List<SnackSlot> snackStorage, SnackTMP? ejectedSnack, VendingState vendingState
});
...
as List<SnackSlot>,ejectedSnack: freezed == ejectedSnack ? _self.ejectedSnack : ejectedSnack // ignore: cast_nullable_to_non_nullable
as SnackTMP?,vendingState: null == vendingState ? _self.vendingState : vendingState // ignore: cast_nullable_to_non_nullable
as VendingState,
  ));
}
